from settings import (np, njit, CHUNK_SIZE, CHUNK_AREA, CHUNK_VOL,
...
def pack_data(x, y, z, voxel_id, face_id, ao_id, flip_id):
    ...
    # voxel_id: 8 bit, face_id: 3 bit, ao_id: 2 bit, flipt_id: 1 bit
...
def is_void(local_voxel_pos, world_voxel_pos, world_voxels):
    ...
    voxel_index = x % CHUNK_SIZE + z % CHUNK_SIZE * CHUNK_SIZE + \
        y % CHUNK_SIZE * CHUNK_AREA
