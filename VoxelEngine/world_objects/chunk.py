from settings import (np, glm, CHUNK_SIZE, CHUNK_AREA, CHUNK_VOL)
...
class Chunk:
    def __init__(self, world, position):
        ...
        self.is_on_frustum = self.app.player.frustum.in_on_frustum

    def get_model_matrix(self):
        m_model = glm.translate(
            glm.mat4(), glm.vec3(self.position) * CHUNK_SIZE)
        return m_model
